...
//        a == a2 //should be true
    ...
    private static void whenCsvContains3ValidPassengers_ThenReturnedListSizeIs3() throws FileNotFoundException {
        ...
        //when
        List<Passenger> passengers = PassengersDataService.readPassengerFromFile(fileContaining3Entries);

        //then
        assert passengers.size() == 3;
    }

    private static void whenFileDoesNotExist_ThenAnExceptionIsThrown() throws FileNotFoundException {
